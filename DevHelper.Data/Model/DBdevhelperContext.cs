...
public partial class DBdevhelperContext : DbContext
{
    ...
    {
        if (optionsBuilder.IsConfigured) optionsBuilder.UseSqlServer("Server=devhelperdb.c2og1m8kyirc.us-east-1.rds.amazonaws.com,1433;Database=devhelperdb;User Id=adminbd;Password=devhelper2024;Encrypt=True;TrustServerCertificate=True;");
    }
